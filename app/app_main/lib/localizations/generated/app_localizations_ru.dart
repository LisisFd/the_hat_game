...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get title_general_last_word => 'Общее последнее слово';
  ...
  @override
  String get title_general => 'общее';

  @override
  String get description_great => 'Пожалуйста, передайте устройство следующему игроку';

  @override
  String get error_input_word => 'Пожалуйста, напишите слово';

  @override
  String get rules_alias => 'Объясните слова, используя синонимы, антонимы, описания и различные подсказки без использования корневых слов.';

  @override
  String get rules_one_word => 'Поскольку на первом этапе вы изучили все слова в шляпе, теперь ваше объяснение должно содержать только одно слово.';

  @override
  String get rules_crocodile => 'Теперь немного подвигаемся. Используйте только мимику, жесты или пляски, чтобы показать своим товарищам слово без звука.';

  @override
  String get helper_words_text => 'Каждый игрок должен написать слова, которые вы будете отгадывать во время игры. (Подсказка: количество слов, которые должен ввести каждый игрок, можно изменить в настройках)';

  @override
  String get helper_game_text => 'Смахните бумажку вправо, если ваша команда угадала слово, и влево, если вы решили его пропустить.';
  ...
  @override
  String get ua => 'Украинский';

  @override
  String get en => 'Английский';

  @override
  String get r => 'Русский';
}
