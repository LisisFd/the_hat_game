...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get description_great => 'Будь ласка, передайте пристрій наступному гравцеві';

  @override
  String get error_input_word => 'Будь ласка, напишіть слово';

  @override
  String get rules_alias => 'Поясніть слова, використовуючи синоніми, антоніми, описи та різні підказки без використання спільнокореневих слів.';

  @override
  String get rules_one_word => 'Оскільки на першому етапі ви вивчили всі слова в капелюсі, тепер ваше пояснення має містити лише одне слово.';

  @override
  String get rules_crocodile => 'Тепер трохи порухаємося. Використовуйте тільки міміку, жести або танці, щоб показати своїм товаришам слово без звуку.';

  @override
  String get helper_words_text => 'Кожен гравець повинен написати слова, які ви відгадаєте під час гри. (Підказка: кількість слів, які повинен ввести кожен гравець, можна змінити в налаштуваннях)';

  @override
  String get helper_game_text => 'Змахніть папірець праворуч, якщо ваша команда вгадала слово, і вліво, якщо ви вирішили його пропустити.';
