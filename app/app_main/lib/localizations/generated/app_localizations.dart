...
abstract class AppLocalizations {
  ...
  /// No description provided for @screen_main_btn_play.
  ///
  /// In en, this message translates to:
  /// **'Play'**
  String get screen_main_btn_play;

  /// No description provided for @screen_main_btn_settings.
  ///
  /// In en, this message translates to:
  /// **'Settings'**
  String get screen_main_btn_settings;

  /// No description provided for @screen_main_btn_rules.
  ///
  /// In en, this message translates to:
  /// **'Rules'**
  ...
  /// In en, this message translates to:
  /// **'Round {number}'**
  String rules_title(String number);
