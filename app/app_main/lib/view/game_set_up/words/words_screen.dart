...
class _WordsScreenState extends State<WordsScreen> {
  ...
  int get countWords => _wordOnOnePlayer - _countWords;

  int get playerNumber => (_playerNumber ?? 0) + _semanticOne;
  ...
  void _updateCurrentPlayer() {
    ...
    final int oldPlayer = _playerNumber ?? newPlayer;
